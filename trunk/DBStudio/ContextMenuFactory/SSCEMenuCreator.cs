...
{
    class SqlCeMenuCreator : MenuBase
    {
        ...
        public sealed override CreateTableSchemaBaseWin GetCreateTableSchemaWindow()
        {
            ...
            CreateTableSchemaBaseWin ctsWin = new CreateTableSchema_SSCE();
            return ctsWin;
        }

        public sealed override ContextMenu CreateMenuForSV_SchemaNode()
        {
            ...
            getItem.Click += (s, e) =>
            {
                string cmdStr = "select * from " + X_CurItemArgs.SystemViewName;
                base.X_CallNotifyEvent(cmdStr, true);
